...
constructor(props) {
 ...
 InsertStudentRecordsToServer = () =>{
      ...
      fetch('https://192.168.1.36/Student/InsertStudentData.php', {
      method: 'POST',
      headers: {
...
class ShowStudentListActivity extends Component {
  ...
  componentDidMount() {
       ...
       return fetch('https://192.168.1.36/Student/ShowAllStudentsList.php')
         .then((response) => response.json())
         .then((responseJson) => {
...
class EditStudentRecordActivity extends Component {
  ...
  constructor(props) {
    ...
    UpdateStudentRecord = () =>{
            ...
            fetch('https://192.168.1.36/Student/UpdateStudentRecord.php', {
            method: 'POST',
            headers: {
              'Accept': 'application/json',
              'Content-Type': 'application/json',
    ...
    DeleteStudentRecord = () =>{
          ...
          fetch('https://192.168.1.36/Student/DeleteStudentRecord.php', {
          method: 'POST',
          headers: {
          'Accept': 'application/json',
          'Content-Type': 'application/json',
